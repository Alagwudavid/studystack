...
class InterestsSeeder extends Seeder
{
    ...
    {
        // Default interests from personal-interests.ts
        $defaultInterests = [
            // Languages
        ...
        // Clear existing default interests (in case of re-seeding)
        Interest::where('is_added_by_user', false)->delete();

        // Insert default interests
        foreach ($defaultInterests as $interest) {
            Interest::create([
                'real_id' => $interest['id'], // Use the original ID as real_id for default interests
                'label' => $interest['label'],
                'user_id' => null, // Default user_id
                'username' => 'default', // Default username
                'is_added_by_user' => false, // This is a default interest
            ]);
        }

        $this->command->info('Default interests seeded successfully!');
    }
}
