...
export function CreatePostModal({ open, onOpenChange, user }: CreatePostModalProps) {
    ...
    const communityOptions = [
        ...
        { id: "UNN-developers", name: "UNN Developers", handle: "@UNNdeveloper", avatar: "🔥", color: "bg-red-500" },
        { id: "GDG", name: "GDG", handle: "@GDG", avatar: "GDG", color: "bg-black" },
        { id: "UNILAG-dev", name: "UNILAG Dev", handle: "@UNILAGdev", avatar: "🐘", color: "bg-blue-500" },
    ];
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="border-0 bg-muted lg:rounded-3xl max-w-2xl h-fit max-h-[90vh] p-0 gap-0 flex flex-col">
                ...
                <div className="px-6 pb-4 flex-1">
                    <div className="relative">
                        <button
                            ...
                            className="w-fit flex mt-4 items-start gap-3 p-2 rounded-lg bg-card/70 hover:bg-card transition-colors cursor-pointer"
                        >
                    ...
                    <div className="mt-4">
                        <Input
                            ...
                            className="w-full bg-transparent border-0 text-lg font-semibold placeholder:text-muted-foreground focus:outline-none focus:ring-0 px-0"
                        />
                    </div>
                    <div className="flex-1 mt-4 relative">
                        ...
                        <textarea
                            ...
                            className="w-full bg-transparent resize-none ring-0 outline-none border-0 text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-none transition-all duration-200"
                            rows={8}
