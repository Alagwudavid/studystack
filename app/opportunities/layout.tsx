        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Bitroot Opportunties - Connect with Learners",
            },
        ],
        locale: "en_US",
        type: "website",
...
interface OpportuntiesLayoutProps {
    children: React.ReactNode;
}

export default function OpportuntiesLayout({ children }: OpportuntiesLayoutProps) {
    return (
        <>
            {children}
        </>
